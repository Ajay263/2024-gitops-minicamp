...
# Path to the Great Expectations context directory on your Airflow worker (ensure this is deployed correctly)
GX_CONTEXT_ROOT_DIR = "/opt/airflow/include/great_expectations"

# Default arguments for the DAG    ajayi 
default_args = {
    'owner': 'airflow',
...
# Define job configurations for various ETL jobs and their validations
job_configs = {
    'products': {
        'dependencies': ['start'],
        'validate': True,
